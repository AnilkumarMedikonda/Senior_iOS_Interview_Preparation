...
Core Swift for senior iOS interviews: language fundamentals, advanced Swift, memory management with ARC, Swift Concurrency, and Combine. Every topic gets working code, a recorded explanation, and written Q&A.
...
Study → Build working code → Explain aloud (recorded) → Write Q&A → Review

## House Rules

- Every topic folder has runnable code, not just notes
- Q&A answers written in interview voice, 60–90 seconds each
